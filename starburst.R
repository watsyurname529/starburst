...
sb_stack_bar <- sb_stack_bar + labs(title = "Orginal Starburst Flavor Popularity", y = "Num. of Votes", x = "Ranking (1 is best, 4 is worst)")
...
sb_side_bar <- sb_side_bar + labs(title = "Orginal Starburst Flavor Popularity", y = "Num. of Votes", x = "Ranking (1 is best, 4 is worst)")
